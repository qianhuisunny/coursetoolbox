 ...
 * @LastEditors: iowen
 * @LastEditTime: 2024-04-11 16:40:56
...
CSF::createSection($prefix, array(
    ...
    'fields'      => array(
        array(
            ...
            'style'   => 'info',
            'content' => '<h4>商城系统</h4>
            <p><b>注意：</b>使用支付功能请先配置好<a href="' . io_get_admin_csf_url('商城设置/支付接口') . '">支付接口</a></p>',
        ),
        array(
            'id'      => 'pay_no_login',
            'type'    => 'switcher',
        ...
        array(
            ...
            'fields'     => array(
                ...
                array(
                    ...
                    'default' => 'search',
                    'after'   => '注意：【搜索框下】需选择<a href="'.io_get_admin_csf_url('搜索设置').'">“搜索布局样式”</a>选项的第2个布局',
                    'class'   => 'compact min',
                ...
                array(
                    ...
                    'fields' => array(
                        ...
                        array(
                            ...
                            .$tip_ico.'如果此处留空，则会获取<a href="' . io_get_admin_csf_url('用户安全/社交登录') . '">社交登录(微信公众号登录)</a>的APPID和AppSecret',
