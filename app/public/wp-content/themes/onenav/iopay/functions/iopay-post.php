 ...
 * @LastEditors: iowen
 * @LastEditTime: 2024-04-11 18:04:08
            ...
            case 'sites':
                ...
                foreach ($lists as $l) {
                    ...
                    if($order){
                        ...
                        $l_btn = '<div class="pay-list-btn d-flex align-items-center bg-muted io-radius p-2 mb-2">';
                        $l_btn .= $_i;
...
function iopay_get_single_annex_down_btn($data, $order='', $class=''){
    ...
    $btn = '<div class="pay-list-btn d-flex flex-column bg-muted io-radius p-2 mb-2 ' . $class . '">';
    $btn .= $_order;
...
function iopay_get_post_pay_body_html($post_type, $echo = true){
    ...
    $html .= '<div class="user-level-body io-radius shadow p-3">';
    $html .= '<h3 class="text-lg flex-fill"><i class="iconfont icon-version mr-2"></i><span>' . $title . '</span></h3>';
...
function iopay_get_post_down_body_html($post_type, $order, $echo = true){
    ...
    $html .= '<div class="user-level-body is-buy io-radius shadow p-3">';
