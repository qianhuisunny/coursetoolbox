 ...
 * @LastEditors: iowen
 * @LastEditTime: 2023-06-06 11:43:15
...
$orderby = !empty($_GET['orderby']) ? $_GET['orderby'] : 'expiry';
$order  = !empty($_GET['order']) ? $_GET['order'] : 'desc';

if(!empty($orderby)){
    $list_data = iopay_get_auto_ad_orderby_type($list_data, $orderby, $order);
}
...
<div class="wrap">
    ...
    <p>状态：<?php echo (io_get_option('auto_ad_s',true)?'已开启':'已关闭') ?> | <a href="<?php echo io_get_admin_csf_url('商城设置/自助自动') ?>">立即前往</a></p>
