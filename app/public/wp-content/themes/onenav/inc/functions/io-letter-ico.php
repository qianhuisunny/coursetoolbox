 ...
 * @LastEditors: iowen
 * @LastEditTime: 2022-07-21 05:44:18
...
function io_letter_avatar_js() {
    $avatar_colors = array(
        '#1abc9c', '#2ecc71', '#3498db', '#9b59b6', '#3fe95e', '#16a085', '#27ae60', '#2980b9', '#8e44ad', '#fc3e50', 
        '#f1c40f', '#e67e22', '#e74c3c', '#00bcd4', '#95aa36', '#f39c12', '#d35400', '#c0392b', '#b2df1e', '#7ffc8d'
    );
