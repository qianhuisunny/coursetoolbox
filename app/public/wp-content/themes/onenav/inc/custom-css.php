...
.btn-dark:hover{background-color:{$bnt_c['color']};border-color:{$bnt_c['color']}}
.sidebar .card .searchform input[type='submit']{border: 1px solid {$bnt_c['color']};background-color:{$bnt_c['color']}}
.sidebar .card .searchform input[type='submit']:hover{border: 1px solid {$bnt_c['hover']};background-color:{$bnt_c['hover']}}"; 
