...
if( io_get_option('ioc_category',true) && !in_array( 'cat', io_get_option('rewrites_category_types', array('tag'), 'types')) ) {
    add_action('created_category', 'io_no_category_base_refresh_rules');
    add_action('edited_category', 'io_no_category_base_refresh_rules');
    add_action('delete_category', 'io_no_category_base_refresh_rules');
    function io_no_category_base_refresh_rules() {
        global $wp_rewrite;
