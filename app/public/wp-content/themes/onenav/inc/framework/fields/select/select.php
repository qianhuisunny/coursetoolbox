    ...
    public function render() {
      ...
      if ( isset( $this->field['options'] ) ) {
        ...
        if ( ( is_array( $options ) && ! empty( $options ) ) || ( ! empty( $args['chosen'] ) && ! empty( $args['ajax'] ) ) ) {
          ...
          echo '<select name="' . esc_attr($field_name) . '"' . $field_class . $multiple_attr . $placeholder_attr . $field_attr . $chosen_data_attr . ' data-old-value="' . esc_attr($this->value ? json_encode($this->value) : '') . '">';
