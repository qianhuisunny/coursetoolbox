...
if ( ! class_exists( 'CSF_Field_code_editor' ) ) {
  class CSF_Field_code_editor extends CSF_Fields {
    ...
    public $cdn_url = 'https://cdn.staticfile.net/codemirror/'; // ---- iowen.cn
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'csf-codemirror' ) ) {
        wp_enqueue_script( 'csf-codemirror', esc_url( $this->cdn_url . $this->version .'/codemirror.min.js' ), array( 'csf' ), $this->version, true );// ---- iowen.cn
      ...
      if ( ! wp_style_is( 'csf-codemirror' ) ) {
        wp_enqueue_style( 'csf-codemirror', esc_url( $this->cdn_url . $this->version .'/codemirror.min.css' ), array(), $this->version );// ---- iowen.cn
      }
