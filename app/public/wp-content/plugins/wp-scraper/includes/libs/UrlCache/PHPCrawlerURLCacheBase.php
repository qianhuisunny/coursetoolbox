...
abstract class PHPCrawlerURLCacheBase
{
    ...
    public const URLHASH_URL = 1;
    public const URLHASH_RAWLINK = 2;
    public const URLHASH_NONE = 3;
     ...
     */
    protected function getDistinctURLHash(PHPCrawlerURLDescriptor $UrlDescriptor): ?string
    {
     ...
     * @param int $level
     */
    public function addLinkPriority($regex, $level): void
    {
