...
class TableRepository implements RepositoryInterface {
    ...
    public function create( array $table_data ): Table|\WP_Error {
        ...
        $table = new Table( $post->ID, $post->post_title, $this->get_row_options(), $asin_rows, $feature_rows, $settings );
    ...
    public function get( int $id ): Table|bool {
        ...
        return new Table( $post->ID, $post->post_title, $this->get_row_options(), $asin_rows, $feature_rows, $settings );
    }
