...
class AmazonOptions {
    ...
    public function get_formats(): array {
        return ! empty( $this->locales[ $this->get_country() ]['language_of_preference']['options'][ $this->get_preferred_language() ] ) ? $this->locales[ $this->get_country() ]['language_of_preference']['options'][ $this->get_preferred_language() ] : '';
    }
