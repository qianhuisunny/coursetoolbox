...
class Menus {
    ...
    public function add_sub_menu_page( array $submenus ): array {
        $submenus[] = array(
            'page_title' => __( 'Amazon Affiliate', 'hostinger-affiliate-plugin' ),
            'menu_title' => __( 'Amazon Affiliate', 'hostinger-affiliate-plugin' ),
    ...
    public function add_admin_bar_items( array $menu_items ): array {
        $menu_items[] = array(
            ...
            'title' => esc_html__( 'Amazon Affiliate', 'hostinger-affiliate-plugin' ),
