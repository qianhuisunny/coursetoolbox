                ...
                if ( $product->get_rating() > 0 ) {
                    ...
                    <div class="product-search-modal__item-result-rating">
                        ...
                        <div class="product-search-modal__item-result-rating-label">
                            <?php // translators: %d: Rating, e.g. 4.8. ?>
                            <?php echo $product->get_rating(); ?> <span><?php echo sprintf( __( '(%d reviews)', 'hostinger-affiliate-theme' ), $product->get_reviews() ); ?></span>
                        </div>
                    </div>
                    <?php
                }
                ...
                <div class="product-search-modal__item-result-bottom">
                    ...
                    if ( ! empty( $price ) ) {
                        ...
                        <div class="product-search-modal__item-result-price">
                            ...
                            echo $product->get_price() . ' ' . $product->get_currency();
